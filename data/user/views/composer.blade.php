...
@section('content')
    ...
    <div class=row v-cloak>
        ...
        <div class="col">
                ...
                <div class="alert alert-warning" v-if="is_verify">
                    ...
                    <form role="form"  @submit.prevent="validateData">
                        <div class="form-group">
                            ...
                            <vue-tags-input
                                    ...
                                    @tags-changed="update" @before-adding-tag="validateTag"  name="recipient">
                        ...
                        <div class="form-group">
                            ...
                            {{--<sms-length name="msg" v-validate="'required'" @input="checksms"></sms-length>--}}
                        ...
                        <div class="form-group" v-show="schedule">
                                ...
                                <div class="col">
                                    <div class="float-left">
                                        <button type="button" class="btn btn-light btn-sm" v-on:click="toggleSchedule">
                                            <i class="fa fa-calendar"></i>&nbsp; @{{scheduleMessage}}</button>
                                    </div>
                                </div>
                                <div class="float-right">
                                    <button type="submit" class="btn btn-primary btn-sm" :disabled="tags.length<=0"><i class="fa" :class="sendIcon"></i>&nbsp;@{{send}}</button>
                                </div>
                            </div>
                        </div>
                    </form>
