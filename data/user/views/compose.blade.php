			...
			<div class="card">
				...
				<div class="card-body">
					<form role="form" @submit.prevent="validateData">
						<div class="row" v-if="senders.length > 0">
							<div class="form-group col-auto">
								<label>Sender Name</label>
								<select name="sender" v-model="sender_name" class="form-control">
						...
						<div class="form-group">
							...
							<button class="btn btn-sm btn-info" type="button" @click="insertTag('Contact Name')">Insert Name</button>
						...
						<div class="form-group" v-if="schedule">
							...
							<div class="text-danger" v-if="errors.has('timezone')">Please select a timezone</div>
						</div>
